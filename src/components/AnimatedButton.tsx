...
interface AnimatedButtonProps {
  ...
  href?: string;
  onClick?: () => void;
  className?: string; // allow adding extra margins if needed
}

const AnimatedButton: React.FC<AnimatedButtonProps> = ({ nowText, playText, href, onClick, className }) => {
  const content = (
    <button className={`chunky-btn ${className || ''}`} onClick={onClick}>
