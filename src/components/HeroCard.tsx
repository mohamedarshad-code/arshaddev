...
const HeroCard = ({ name, role, github, linkedin }: { name: string; role: string; github: string; linkedin: string; }) => {
  return (
    <div className="card-wrapper">
      <div className="hero-card">
        <div className="hero-card-photo" />
        <div className="hero-card-title">{name} <br />
          <span>{role}</span>
        </div>
        <div className="hero-card-socials">
          <a href={github} target="_blank" rel="noreferrer" className="hero-card-socials-btn github">
          ...
          <a href={linkedin} target="_blank" rel="noreferrer" className="hero-card-socials-btn linkedin">
